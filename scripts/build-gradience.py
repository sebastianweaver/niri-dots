...
parser.add_argument(
    "--pwfox", dest="pwfox", action="store_true", help="pywalfox matching colors"
)
parser.add_argument("--bar-height", dest="height", help="header bar height")
parser.add_argument("--buttons", dest="buttons", help="button styling, fill or asset")
...
base_cache_dir = os.environ.get("XDG_CACHE_HOME", "/home/{}/.cache/".format(username))
